    ...
    return (
            <TwoColumns key={id}>
                <div className="specific__attraction-item">
                    <img className="specific__attraction-img" src={HouseImg} alt="Attraction in town of Bergen" />
                </div>
                <div className="specific__attraction-item">
                    <img className="specific__attraction-img" src={StatueImg} alt="Attraction in town of Bergen" />
                </div>
            </TwoColumns>
    )
}
